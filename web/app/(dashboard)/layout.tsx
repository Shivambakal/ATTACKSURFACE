        ...
        >
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              title={sidebarCollapsed ? "Expand / Pin Sidebar ( [ )" : "Collapse to Hover Mode ( [ )"}
              aria-label="Toggle Sidebar"
              className="group relative flex h-9 items-center gap-2 rounded-2xl border px-3 text-xs font-semibold tracking-tight transition-all duration-300 active:scale-95 cursor-pointer shadow-sm bg-white/[0.05] hover:bg-white/[0.1] border-white/[0.08] text-slate-200 hover:text-white dark:bg-white/[0.05] dark:hover:bg-white/[0.1] dark:border-white/[0.08] [data-theme=white-aesthetic]:bg-slate-100/90 [data-theme=white-aesthetic]:hover:bg-slate-200 [data-theme=white-aesthetic]:border-slate-300 [data-theme=white-aesthetic]:text-slate-800"
            >
              <div className="relative flex h-4 w-4 items-center justify-center">
                <svg
                  className={`h-4 w-4 transition-transform duration-300 ${
                    sidebarCollapsed ? "rotate-0 text-cyan-400 [data-theme=white-aesthetic]:text-sky-600" : "rotate-180 text-cyan-300 [data-theme=white-aesthetic]:text-sky-700"
                  }`}
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
              ...
              <span className="hidden sm:inline font-mono text-[11px] uppercase tracking-wider">
                {sidebarCollapsed ? "Menu" : "Pinned"}
              </span>
              <span
                className={`h-1.5 w-1.5 rounded-full transition-colors ${
                  sidebarCollapsed ? "bg-slate-500" : "bg-cyan-400 shadow-[0_0_6px_#00f0ff] [data-theme=white-aesthetic]:bg-sky-600"
                }`}
              />
            </button>

            <span className="hidden md:inline text-sm font-semibold tracking-tight text-slate-200 [data-theme=white-aesthetic]:text-slate-900 font-display">
              {getPageTitle()}
            </span>
          </div>
