          ...
          <Step>
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 rounded-xl border border-slate-700 bg-slate-800/80 hover:bg-slate-750 py-2.5 px-4 text-xs font-semibold text-slate-100 transition active:scale-[0.99] shadow-sm"
              >
              ...
              <div className="relative my-2 flex items-center justify-center text-xs">
                <div className="w-full border-t border-slate-800" />
                <span className="bg-slate-900/90 px-2 text-[10px] font-mono uppercase text-slate-500 shrink-0">
